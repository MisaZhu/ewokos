...
void sys_info_init_arch(void) {
	...
	if(pix_revision == PI_4B_1G) {
		...
		_sys_info.total_usable_mem_size = 1u*GB;
		...
		_sys_info.total_usable_mem_size = 2u*GB;
		_sys_info.mmio.phy_base = 0xfe000000;
		_core_base_offset =  0x01800000;
		_pi4 = 1;
	}
		...
		_sys_info.total_usable_mem_size = 4u*GB;
		_sys_info.mmio.phy_base = 0xfe000000;
		_core_base_offset =  0x01800000;
		_pi4 = 1;
	}
		...
		_sys_info.total_usable_mem_size = 4u*GB; //max for 32bits os
		_sys_info.mmio.phy_base = 0xfe000000;
		_core_base_offset =  0x01800000;
		_pi4 = 1;
	}
		...
		_sys_info.total_usable_mem_size = 512*MB;
		_sys_info.mmio.phy_base = 0x3f000000;
	}
