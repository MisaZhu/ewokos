...
extern int32_t proc_get_root_pid_visible(int32_t pid);
extern int32_t proc_get_current_thread_id_safe(void);
extern int32_t proc_get_current_uid_safe(void);
extern int32_t proc_get_current_gid_safe(void);
extern int32_t proc_get_cmd_safe(int32_t pid, char* cmd, int32_t sz);
extern int32_t proc_get_ready_ping_safe(int32_t pid);
extern int32_t proc_get_core_pid_safe(void);
extern void    proc_set_core_pid_safe(int32_t pid);
...
extern void    proc_lock_enter(void);
extern void    proc_lock_leave(void);
#endif
