 ...
 */
static int32_t __attribute__((optimize("O0"))) bcm283x_sd_init(void) {
	_sdc.rxdone = 1;
	_sdc.txdone = 1;
...
static int32_t bcm283x_sd_read(int32_t sector) {
	if(_sdc.rxdone == 0)
		return -1;
...
static int32_t bcm283x_sd_read_done(void* buf) {
	sd_dev_handle();
	if(_sdc.rxdone == 0)
		return -1;
