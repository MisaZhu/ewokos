...
#ifdef MP3_MUSIC
        case MUS_MP3:
            left = MP3_playAudio(music_playing->data.mp3, stream, len);
            break;
#endif
#ifdef MP3_MAD_MUSIC
            case MUS_MP3_MAD:
...
Mix_Music *Mix_LoadMUSType_RW(SDL_RWops *src, Mix_MusicType type, int freesrc)
{
    ...
    case MUS_MP3:
        music->type = MUS_MP3;
        music->data.mp3 = MP3_new_RW(src, freesrc);
        if (music->data.mp3) {
            music->error = 0;
        } else {
            Mix_SetError("Could not initialize MP3 stream.");
        }
        break;
...
#ifdef MP3_MUSIC
        case MUS_MP3:
        MP3_play(music_playing->data.mp3);
        break;
#endif
#ifdef MP3_MAD_MUSIC
        case MUS_MP3_MAD:
...
#ifdef MP3_MUSIC
        case MUS_MP3:
        MP3_jump_to_time(music_playing->data.mp3, position);
        MP3_play(music_playing->data.mp3);
        break;
#endif
#ifdef MP3_MAD_MUSIC
...
#ifdef MP3_MUSIC
        case MUS_MP3:
        MP3_setvolume(music_playing->data.mp3, volume);
        break;
#endif
#ifdef MP3_MAD_MUSIC
        case MUS_MP3_MAD:
...
#ifdef MP3_MUSIC
        case MUS_MP3:
        MP3_stop(music_playing->data.mp3);
        break;
#endif
#ifdef MP3_MAD_MUSIC
        case MUS_MP3_MAD:
...
#ifdef MP3_MUSIC
        case MUS_MP3:
        if ( !MP3_playing(music_playing->data.mp3) )
            playing = 0;
        break;
#endif
#ifdef MP3_MAD_MUSIC
