    ...
    void PictureBus::updateMirroring()
    {
        switch (m_mapper->getNameTableMirroring())
        {
            case Horizontal:
                ...
                printf("Horizontal Name Table mirroring set. (Vertical Scrolling)\n"); 
                break;
            case Vertical:
                NameTable0 = NameTable2 = 0;
                NameTable1 = NameTable3 = 0x400;
                printf( "Vertical Name Table mirroring set. (Horizontal Scrolling)\n" );
                break;
            case OneScreenLower:
                NameTable0 = NameTable1 = NameTable2 = NameTable3 = 0;
                printf( "Single Screen mirroring set with lower bank.\n" );
                break;
            case OneScreenHigher:
                NameTable0 = NameTable1 = NameTable2 = NameTable3 = 0x400;
                printf( "Single Screen mirroring set with higher bank.\n" );
                break;
            default:
                NameTable0 = NameTable1 = NameTable2 = NameTable3 = 0;
