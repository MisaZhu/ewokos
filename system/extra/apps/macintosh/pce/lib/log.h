...
#if 0
#define pce_log(level, msg, args...)  printf(msg, ##args)
#define pce_log_deb(msg, args...)  printf(msg, ##args)
#define pce_log_tag(level, tag, msg, args...)  do{printf("%s\t ", tag);printf(msg, ##args);}while(0)
#else
