...
typedef struct proto_factor {
	...
	struct proto_factor* (*addi64)(proto_t* proto, int64_t i);
	struct proto_factor* (*adda)(proto_t* proto, ewokos_addr_t a);
...
int64_t         proto_read_int64(proto_t* proto);
ewokos_addr_t   proto_read_addr(proto_t* proto);
