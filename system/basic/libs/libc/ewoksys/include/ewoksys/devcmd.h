...
extern int dev_close(int dev_pid, int fd, int pid, uint32_t node);
extern int dev_open(int dev_pid, int fd, uint32_t node, int oflag);
extern int dev_read(int dev_pid, int fd, uint32_t node, int32_t offset, void* buf, uint32_t size);
extern int dev_write(int dev_pid, int fd, uint32_t node, int32_t offset, const void* buf, uint32_t size);
