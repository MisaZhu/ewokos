target("libsoftfloat")
    set_type("library")
    add_includedirs(".", "source/include", "source/ARM-VFPv2")
    add_defines("SOFTFLOAT_ROUND_ODD","INLINE_LEVEL=5")
    add_cflags("-Werror-implicit-function-declaration", "-O2")
    add_files(
        ...
        "source/arm32_aeabi_softfloat.c"
    )        
target_end()
