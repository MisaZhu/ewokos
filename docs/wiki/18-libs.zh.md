...
| [openlibm](../../system/basic/libs/openlibm/) | `-lopenlibm` | `math.h` | 数学库 `libm`（[17](17-libc.zh.md) 章已介绍） |
...
接下来做什么？回到 [15 调试与进阶](15-debug.zh.md)，或挑一个库读它的源码——
